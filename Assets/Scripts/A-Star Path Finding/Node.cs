...
public class Node
{
    ...
    public bool bIsPlayer;//Tells the program if this node is being obstructed.
    public GameObject playerAtNode;
    ...
    public Node(bool a_bIsPlayer, bool a_bIsWall, Vector3 a_vPos, int a_igridX, int a_igridY)//Constructor
    {
        bIsPlayer = a_bIsPlayer;
